...
import { Mic, BarChart3, TrendingUp, Award, BarChart2, Dumbbell } from 'lucide-react';
...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    if (!onboardingCompleted && !hasSessions) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-slate-600">Track your speech progress and eliminate filler words.</p>
          </div>
        ...
        {!hasSessions ? (
          <div className="bg-white rounded-2xl shadow-sm p-8 text-center">
            ...
            <p className="text-slate-600 mb-6 max-w-md mx-auto">
              Start your first speaking session to track your filler words and improve your clarity.
            </p>
